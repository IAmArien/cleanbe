...
export class UserInfoRepository {
  createUserInfo(userInfo: UserInfoRequestDto) {
    return new Promise<UserInfoResponseDto>(async (resolve, reject) => {
      try {
  ...
  getUserInfo(userId: number) {
    return new Promise<UserInfoResponseDto | null>(async (resolve, reject) => {
      try {
    ...
    return new Promise<UserInfoResponseDto | null>(async (resolve, reject) => {
      try {
        ...
        if (findModel !== null) {
          ...
          const updateModel = await UserInfoModel.update(partialUserInfo, {
            where: { id: userId },
          });
